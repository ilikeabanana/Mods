...
namespace LoggingEveryAddressable
{
    // TODO Review this file and update to your own requirements.

    [BepInPlugin(MyGUID, PluginName, VersionString)]
    public class LoggingEveryAddressablePlugin : BaseUnityPlugin
    {
        ...
        // e.g.
        // 1.0.0
        private const string MyGUID = "com.michi.LoggingEveryAddressable";
        private const string PluginName = "LoggingEveryAddressable";
        ...
        // e.g.
        // float myFloat = LoggingEveryAddressablePlugin.FloatExample.Value;
        ...
        private void Awake()
        {
            ...
            // .e.g.
            // LoggingEveryAddressablePlugin.Log.LogDebug("Debug Message to BepInEx log file");
            Log = Logger;
        }
        ...
        private void Update()
        {
            if (LoggingEveryAddressablePlugin.KeyboardShortcutExample.Value.IsDown())
            {
