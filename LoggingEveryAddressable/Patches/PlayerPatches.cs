...
namespace LoggingEveryAddressable.Patches
{
    ...
    internal class PlayerPatches
    {
        ...
        {
            LoggingEveryAddressablePlugin.Log.LogInfo("In Player Awake method Prefix.");
            return true;
        }
        ...
        {
            LoggingEveryAddressablePlugin.Log.LogInfo("In Player Awake method Postfix.");
        }
    }
}