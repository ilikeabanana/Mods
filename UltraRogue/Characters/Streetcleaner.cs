...
namespace Ultrarogue.Characters
{
    public class Streetcleaner : BaseCharacter
    {
        ...
        public override string Description => "Start with the fire starter and gasoline. All gasoline will immediately ignite. <color=red>FIRE DOES NOT HURT YOU ANYMORE, LIGHTING ENEMIES ON FIRE HEALS YOU</color>";
