...
namespace Ultrarogue.Characters
{
    public class RandomCharacter : BaseCharacter
    {
        ...
        public override string Description => "Start with 2 random weapons, 2 random items, and 2 random passives.";
        ...
        private static List<Passive> RollPassives()
        {
            ...
            all.Remove(first);
            Passive second = all[Rng.Next(all.Count)];

            return new List<Passive> { first, second };
        }
    }
}