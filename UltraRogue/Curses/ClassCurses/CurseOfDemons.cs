...
{
    public class CurseOfDemons : BaseCurse
    {
        public override string CurseName => "Curse of Demons";
        public override bool OverrideEnemySpawning => true;

        public override bool CanApply()
        {
            foreach (SpawnableObject obj in AssetsManager.enemiesByClass["Demon"])
            {
        ...
        {
            SpawnableObject[] objects = AssetsManager.enemiesByClass["Demon"].ToArray();
