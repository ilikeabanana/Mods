...
{
    public class CurseOfDivine : BaseCurse
    {
        public override string CurseName => "Curse of The Divine";
        public override bool OverrideEnemySpawning => true;

        public override bool CanApply()
        {
            foreach (SpawnableObject obj in AssetsManager.enemiesByClass["Angel"])
            {
        ...
        {
            SpawnableObject[] objects = AssetsManager.enemiesByClass["Angel"].ToArray();
