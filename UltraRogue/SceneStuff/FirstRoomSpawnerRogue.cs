...
using UnityEngine.UI;
    ...
    public class FirstRoomSpawnerRogue : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        public void Deserialize()
        {
            ...
            {
                LayerInfoRogue layer = new LayerInfoRogue();
        ...
        public static void ConvertToAscendingFirstRoom(GameObject firstRoom, AudioClip doorCloseAud, List<GameObject> toEnable, List<GameObject> toDisable, bool doNotReplace)
        {
            ...
            if (!doNotReplace)
            {
                ...
                t4.GetComponent<MeshRenderer>().materials = new Material[2] { UtilsRogue.metalDec20, UtilsRogue.metalDec20 };
                ...
                t5.GetComponent<MeshRenderer>().materials = new Material[2] { UtilsRogue.metalDec20, UtilsRogue.metalDec20 };
        ...
        public void Spawn()
        {
            ...
            UtilsRogue.SetPlayerWorldRotation(Quaternion.Euler(0, transform.rotation.eulerAngles.y, 0));
            ...
            try
            {
                ...
                if (enableHellMap)
                {
                    ...
                    foreach (LayerInfoRogue layer in layersAndLevels)
                    {
                        // Add the layer text
                        ...
                        header.fontSize = 36;
                        header.font = UtilsRogue.gameFont;
                    ...
                    cursorImg.sprite = UtilsRogue.hellmapArrow;
                    ...
                    ObjectActivator act = UnityUtilsRogue.GetComponentInChildrenRecursive<PlayerActivator>(firstRoomInst.transform).gameObject.AddComponent<ObjectActivator>();
